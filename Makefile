...
CFLAGS		=	-g -O3 -Wall -Wextra -fpermissive -Wno-error=implicit-function-declaration $(MACHDEP) $(INCLUDE) `freetype-config --cflags`
CXXFLAGS	=	$(CFLAGS)
...
#---------------------------------------------------------------------------------
LIBS :=	-lpng `freetype-config --libs` -lz -lfat -lwiiuse -lbte -lasnd -logc -lvorbisidec -logg -lcurl -lz -lmbedtls -lmbedcrypto -lmbedx509 -logc -lwiisocket -lm -ljsoncpp
#---------------------------------------------------------------------------------
