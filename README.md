...
cd to the directory and build by running "make" from inside the DevKitPPC environment shell: https://wiibrew.org/wiki/DevkitPPC

Sideload the resulting dol/elf to your Wii's Homebrew Channel. You can also emulate it on Dolphin, but I've found networking support to be spotty in emulation.

![](https://imgur.com/HdY3sKI.jpg)

![](https://imgur.com/qdvwZ6l.jpg)
